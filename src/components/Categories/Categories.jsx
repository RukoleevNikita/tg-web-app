...
export const Categories = ({ eventHandler, activeIndex = 0 }) => {
  ...
  const CATEGORIES = ['Все товары', '1 сентября/учителю', 'Мужские букеты', 'Букеты', 'Клубничные букеты', 'Букеты из шоколадных цветов', 'Подарки для детей', 'Шары и композиции'];
